...
# This plugin only
ln -s /path/to/dev-cusor-plugins/backend-dev-kit ~/.cursor/plugins/local/backend-dev-kit
```
...
| `express-feature` | Adding a resource (table, Zod, repo, service, router, tests) |
